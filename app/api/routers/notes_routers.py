...
from app.api.repositories.notes_repositories import get_note_repository
from app.api.services.notes_services import get_note_service
from app.api.repositories.notes_repositories import NoteRepository
...
async def list_notes(
    ...
    note_service.note_repo = note_repo # Inject repo
...
async def get_note(
    ...
    note_service.note_repo = note_repo
